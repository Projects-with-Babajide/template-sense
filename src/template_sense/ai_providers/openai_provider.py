    ...
    def _build_system_prompt(self, context: str) -> str:
        ...
        if context == "headers":
            return (
                ...
                "Return your response as valid JSON with a 'headers' key containing an array "
                "of classified fields. Include optional fields (label_col_offset, value_col_offset, "
                "pattern_type) when patterns are detected."
            )
        if context == "columns":
            return (
